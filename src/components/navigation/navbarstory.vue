<template>
  <div
    class="bg-white bg-opacity-5 backdrop-blur-[2px] shadow-md w-[80%] h-[75vw] absolute bottom-[88%] left-auto right-[10%] z-20"
  ></div>
  <!-- list of thumbnail -->
  <div
    class="flex overflow-auto w-[39%] lg:w-[29%] mx-auto z-30 relative no-scrollbar rounded-full items-center"
  >
    <img
      class="w-12 h-12 lg:w-14 lg:h-14 xl:w-16 xl:h-16 rounded-full p-1"
      src="../../../public/picture/profile-picture-5.jpg"
    />
    <img
      class="w-12 h-12 lg:w-14 lg:h-14 xl:w-16 xl:h-16 rounded-full p-1"
      src="../../../public/picture/profile-picture-5.jpg"
    ...
    <!-- all connection -->
    <div
      class="w-10 h-10 xl:w-16 xl:h-16 rounded-full p-1 ring-2 ring-red-500 flex justify-center items-center"
    >
      <svg
        viewBox="0 -0.5 25 25"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        class="w-12 h-12 lg:w-14 lg:h-14 xl:w-16 xl:h-16 text-gray-500 dark:text-gray-800 hover:text-blue-600 dark:hover:text-blue-500"
      >
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
